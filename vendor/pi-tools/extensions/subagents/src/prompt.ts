...
export const SUBAGENT_SPAWN_PROMPT_GUIDELINES = [
  ...
  "Pi subagents accept only exact model tiers: openai-codex/gpt-6-luna or openai-codex/gpt-6-sol. openai-codex is Pi's provider name, not a Codex CLI harness.",
  "For orchestrated work, choose model and reasoning_effort independently instead of inheriting either from the parent. Use Luna for focused scouts/verifiers, broad exploration, and precisely scoped low-risk implementation with an existing pattern and deterministic check; set Luna effort low for mechanical work, medium for multi-step reasoning, or high only when bounded work is genuinely difficult. Use Luna medium for ambiguous root causes or broad/coupled multi-file implementation, Sol low for routine review and domain decisions, and Sol medium for planning or complex synthesis. Luna and Sol are routing tiers, not valid Pi model hints: pass an exact available provider/model-id such as openai-codex/gpt-6-luna, never the shorthand luna or sol.",
...
export const SUBAGENT_SPAWN_PARAMETER_DESCRIPTIONS = {
  ...
  model:
    "Exact Pi model tier: openai-codex/gpt-6-luna or openai-codex/gpt-6-sol. Set it explicitly for orchestrated work.",
  reasoningEffort:
