...
export const SUBAGENT_SPAWN_PROMPT_GUIDELINES = [
  ...
  "For orchestrated work, set model and reasoning_effort explicitly instead of inheriting the parent: Luna low for focused scouts/verifiers, Luna medium for broad exploration, Terra low for bounded or multi-file implementation and root-cause fixes, Sol low for routine review, and Sol medium for planning or complex synthesis. Luna, Terra, and Sol are routing tiers, not valid Pi model hints: pass an exact available provider/model-id such as openai-codex/gpt-5.6-terra, never the shorthand luna, terra, or sol.",
