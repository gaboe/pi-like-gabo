...
export const CHILD_COST_CHANNEL = "dashboard:child-cost";
export const CHILD_COST_ENTRY = "dashboard-child-cost";
...
export interface ChildCostUpdate {
  key: string;
  cost: number;
  settled: boolean;
}
...
export function isChildCostUpdate(value: unknown): value is ChildCostUpdate {
