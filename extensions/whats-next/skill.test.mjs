...
test("packages portable whats-next skill with completion and approval guards", () => {
  ...
  assert.match(root("skills/whats-next/references/harnesses.md"), /tool-free Terra child/);
  ...
  assert.match(extension, /selecting an option authorizes its exact stated scope/);
  assert.match(extension, /do not ask them to repeat, confirm, or send a follow-up message/);
});
